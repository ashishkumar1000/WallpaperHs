 ...
 * Usage:
 *
 * int sampleInt = SharedPrefUtils.getInstance(context).getInt(Key.SAMPLE_INT);
 * SharedPrefUtils.getInstance(context).set(Key.SAMPLE_INT, sampleInt);
 *
 * If SharedPrefUtils.getInstance(Context) has been called once, you can
 * simple use SharedPrefUtils.getInstance() to save some precious line space.
 */
public class SharedPrefUtils {
    // TODO: CHANGE THIS TO SOMETHING MEANINGFUL
    private static final String SETTINGS_NAME = "default_settings";
    private static SharedPrefUtils sSharedPrefs;
    ...
    public static SharedPrefUtils getInstance(Context context) {
        if (sSharedPrefs == null) {
            sSharedPrefs = new SharedPrefUtils(context.getApplicationContext());
        }
        return sSharedPrefs;
    }
    ...
    public static SharedPrefUtils getInstance() {
        if (sSharedPrefs != null) {
            ...
            return getInstance(AppUtils.getInstance().getContext());
        }
    }
